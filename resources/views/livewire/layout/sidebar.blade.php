<!-- Agrega x-data en un contenedor general -->
<div x-data="{ sidebarOpen: false }">
    <!-- Botón hamburguesa -->
    <button @click="sidebarOpen = !sidebarOpen"
        class="fixed top-0 z-[5000] inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform transform bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 -translate-x-full sm:translate-x-0"
        :class="{ 'translate-x-0': sidebarOpen }" x-transition>
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="{{ route('bienvenida') }}"
                        ...
                        <span class="ms-3">Bienvenida</span>
                    </a>
                </li>
                @if (Auth::check() && Auth::user()->tipo === 'Administrador')
                    <li>
                        <a href="{{ route('administracion') }}"
                            ...
                            <span class="flex-1 ms-3">Panel de Administración</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('apis.externa-clima') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <span class="flex-1 ms-3">API Externa Clima</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('apis.externa-store') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <span class="flex-1 ms-3">API Externa Store</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('apis.interna-usuarios') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <span class="flex-1 ms-3">API Interna Usuarios</span>
                        </a>
                    </li>
                @endif
                @if (Auth::check() && Auth::user()->tipo === 'Cliente')
                    <li>
                        <a href="{{ route('productos') }}"
                            ...
                            <span class="flex-1 ms-3">Productos a la Venta</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('ventas') }}"
                            ...
                            <span class="flex-1 ms-3">Listado de Ventas</span>
                        </a>
                    </li>
                @endif
            </ul>

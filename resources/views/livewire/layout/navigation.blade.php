                ...
                <div class="flex flex-col items-center justify-center gap-6">
                    ...
                    <div class="flex items-center gap-2">
                        <button id="theme-toggle" type="button"
                            class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-0 rounded-lg text-sm p-2.5">
                        ...
                        <span id="theme-status" class="hidden sm:inline text-sm text-gray-700 dark:text-gray-300"> Estás utilizando el
                            modo ... </span>
                    </div>
                </div>
            </div>

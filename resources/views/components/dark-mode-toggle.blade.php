<div x-data="darkModeToggle" x-init="init()" class="flex items-center gap-2">
    <button @click="toggleTheme" type="button"
        ...
        <svg x-cloak :class="isDark ? 'opacity-100' : 'opacity-0 pointer-events-none'"
            class="absolute inset-0 w-5 h-5 transition-opacity duration-200" fill="currentColor" viewBox="0 0 20 20">
    ...
    <span class="sm:inline text-sm text-gray-700 dark:text-gray-300"
